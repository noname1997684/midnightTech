...
export async function generateMetadata({params}) {
  ...
  return {
    ...
    description: product?.shortDescription ?? "An E Commerce Website built with Next.js, React, and Tailwind CSS",
    openGraph:{
  ...
  return (
    <main className='p-5 md:p-10'>
        <section className='flex flex-col-reverse md:flex-row gap-3'>
              <Photos imageList={[product.featureImageURL,...(product.imagesURLs?? [])]}/>
